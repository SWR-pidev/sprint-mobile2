...
public class Event {
    ...
    public Event(int id_evt, String name, Date date_evt, TimeZone time_evt, String location, String details, double budget, String organizator, String url_evt, int nbviews, int nbsponsor, int nbparticipant, int nbreport, int state_evt, double stillneeded_evt) {
        this.id_evt = id_evt;
        this.name = name;
    ...
    public Event(int id_evt, String name, Date date_evt, TimeZone time_evt, String location, String details, double budget, String organizator, String url_evt) {
        this.id_evt = id_evt;
        this.name = name;
        this.date_evt = date_evt;
        this.time_evt = time_evt;
    ...
    public Event(int id_evt, String name, Date date_evt, TimeZone time_evt, String location, String details, double budget, String organizator, String url_evt, double stillneeded_evt) {
        this.id_evt = id_evt;
        this.name = name;
        this.date_evt = date_evt;
        this.time_evt = time_evt;
    ...
    public Event(String name, Date date_evt, TimeZone time_evt, String location, String details, double budget, String organizator, String url_evt) {
        this.name = name;
        this.date_evt = date_evt;
        this.time_evt = time_evt;
        this.location = location;
    ...
    public TimeZone getTime_evt() {
        return time_evt;
    }

    public void setTime_evt(TimeZone time_evt) {
        this.time_evt = time_evt;
    }
